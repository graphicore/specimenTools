define([
  ...
  , TransformPen
    ...
    _BaseDrawingElement.prototype.setExtends = function(x1, x2) {
        var i,l, args=[];
    ...
    YLine.prototype.setExtends = function(x1, x2/*, height*/) {
        if(x1 !== null)
    ...
    var instructions = {
      ...
      , testText: ['box',
            [
                ['text', 'Hamburger', {align: 'center', style: 'normal'}]
              , ['yline', 'baseLine', {style: 'normal', insert: 0}]// 0 = insert as first element, -1 = insert as last element
    ...
    _p._getFontDimensions = function(font) {
        ...
        ascent = this._container.hasAttribute('data-diagram-ascent')
                ? parseFloat(this._container.getAttribute('data-diagram-ascent'))
                : font.tables.os2.usWinAscent
                ;
        descent = this._container.hasAttribute('data-diagram-descent')
                ? parseFloat(this._container.getAttribute('data-diagram-descent'))
                : font.tables.os2.usWinDescent
                ;
        height = this._container.hasAttribute('data-diagram-height')
                ? parseFloat(this._container.getAttribute('data-diagram-height'))
                : ascent + descent
                ;
    ...
    _p._onActivateFont = function(fontIndex) {
        ...
        childItem.setExtends(-childItem.leftSideBearing, width-childItem.leftSideBearing);

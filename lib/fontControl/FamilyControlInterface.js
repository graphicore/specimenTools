define([
    ...
    function FamilyControlInterface(container, pubSub, fontsData, options) {
    ...
    _p._makeWeightButton = function(familyIndex, weight) {
        ...
        applyClasses(weightButton, this._options.weightButtonClasses);
    ...
    _p._setWeightButton = function(weightButton, isActive) {
        applyClasses(weightButton, this._options.weightButtonActiveClass, !isActive);
        weightButton.classList[isActive ? 'add' : 'remove'](this._options.weightButtonActiveClass);
    };

define([
    ...
    _p.__getCharSetsCoverageInfo = function(fontIndex, useLaxDetection) {
        var charSets = this._options.charSets;
        if(!charSets)
            throw new Error('To use "getCharSetsCoverageInfo" the optionial "charSets" must be set.');
        return FontsData.getCharSetsCoverageInfo(charSets, this._data[fontIndex].font, useLaxDetection);
    };

    _p.getCharSetsCoverageInfo = function(fontIndex) {
        var func = this._options.useLaxDetection
                                    ? 'getCharSetsCoverageInfoLax'
                                    : 'getCharSetsCoverageInfoStrict'
                                    ;
        return this[func](fontIndex);
    };

    _p._getCharSetsCoverageInfoStrict = function(fontIndex) {
        return this.__getCharSetsCoverageInfo(fontIndex, false);
    };

    _p._getCharSetsCoverageInfoLax = function(fontIndex) {
        return this.__getCharSetsCoverageInfo(fontIndex, this._options.useLaxDetection || true);
    };
    ...
    _p.__getCharSetInfo = function (name) {
    ...
    _p._getSupportedLanguagesByCharSets = function(fontIndex) {
        ...
        languagesSet.forEach(Array.prototype.push, result);
        result.sort();
        return result;
    };

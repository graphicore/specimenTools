define([
  ...
  , languageCharSetsJson
    ...
    FontsData.getLanguageCoverageForCharSet = function getLanguageCoverageForCharSet(charset, useLaxDetection) {
        var result = []
    ...
    FontsData.getLanguageCoverage = function getLanguageCoverage(font, useLaxDetection) {
        ...
        return FontsData.getLanguageCoverageForCharSet(charSet, useLaxDetection);
    };
